...
public class Message {
    ...
    private Integer postedBy;      //who posted the message
    
    @Column (name="messageText")
    private String messageText;
   
    @Column (name="timePostedEpoch")
    private Long timePostedEpoch;      //time of posting
  
    // default constructor
    public Message(){
    }
   
    //constructor to post new message , id will be generated by database
    ...
    //constructor to retrieve message object from database
